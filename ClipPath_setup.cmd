...
reg delete "HKEY_CURRENT_USER\Software\Classes\*\shell\Path2Clip"

::create the entry
reg add "HKEY_CURRENT_USER\Software\Classes\*\shell\ClipPath" /f /ve /d "ClipPath"
...
reg add "HKEY_CURRENT_USER\Software\Classes\*\shell\ClipPath\command" /f /ve /t REG_EXPAND_SZ /d "\"%elevatorpath%\" -hide -c \"\\\"%~dp0ClipPath.cmd\\\" \\\"%%L\\\"\"
::in the registry we want it to wind up like this
::  "c:\bin\Elevator.exe" -v -c "\"C:\Users\banderson\OneDrive - PERK\Brent\bin\ClipPath\ClipPath.cmd\" \"%L\""
::then elevator receives this:
::  ApplicationName: C:\WINDOWS\system32\cmd.exe
::  CommandLine:     /s /c ""C:\Users\banderson\OneDrive - PERK\Brent\bin\ClipPath\ClipPath.cmd" "\\kc.kingcounty.lcl\dnrp\LAB\IT\Vacation Planning\2018 Holidays Vacation Planning.xlsx" "
...
reg add "HKEY_CURRENT_USER\Software\Classes\*\shell" /f /ve /t REG_SZ /d ClipPath
